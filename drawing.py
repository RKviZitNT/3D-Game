...
class Drawing:
	def __init__(self, screen):
		...
		self.textures = {'0': pygame.image.load("texture/texture0.jpg").convert(),
						 '1': pygame.image.load("texture/texture1.jpg").convert(),
						 }
	...
	def world(self, player_pos, player_angle):
		...
		# 	with lock:
		# 		ray_casting(self.screen, player_pos, player_angle, self.texture, num_thread)
		#
		# threads = []
		#
